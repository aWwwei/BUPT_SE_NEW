...
@ 修改描述： 增加数据库操作类UserTable，用于操作用户表
@ 修改人：  田健豪
@ 修改日期： 2023年12月7日

@ 修改描述： 增加数据库操作类CheckTable，用于操作房间登记表
@ 修改人：  田健豪
@ 修改日期： 2023年12月7日

@ 修改描述： 增加数据库操作类DetailsTable，用于操作详单表
@ 修改人：  田健豪
@ 修改日期： 2023年12月7日

@ 修改描述： 增加数据库操作类database，用于建立数据库连接
@ 修改人：  田健豪
@ 修改日期： 2023年12月7日

@ 修改描述： 修改数据库操作类DetailsTable，增加表的属性cost，用于记录费用
@ 修改人：  田健豪
@ 修改日期： 2023年12月9日
"""
