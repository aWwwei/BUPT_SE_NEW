...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_6.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(253, 231, 223, 255), stop:1 rgba(223, 228, 226, 255));\n"
"border-radius:20px ")
        ...
        self.frame_4.setStyleSheet("background-color:  qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(253, 243, 232, 255), stop:1 rgba(223, 228, 226, 255));")
...
"}")
        ...
        self.widget.setStyleSheet("image: url(:/登陆界面/空调2.png);\n"
...
"border-with:0;border-style:outset；")
        ...
        self.lineEdit_roomnumber = QtWidgets.QLineEdit(self.frame_7)
        self.lineEdit_roomnumber.setStyleSheet("QLineEdit{\n"
"    background-color: rgba(255, 255, 255, 0);\n"
...
"\n"
"")
        self.lineEdit_roomnumber.setText("")
        self.lineEdit_roomnumber.setObjectName("lineEdit_roomnumber")
        self.horizontalLayout_6.addWidget(self.lineEdit_roomnumber)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_roomnumber.setPlaceholderText(_translate("MainWindow", "请输入房间号"))
